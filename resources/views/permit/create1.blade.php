            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/permit/store1') }}">
                        ...
                        <div class="form-group{{ $errors->has('hours_taken') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Hrs. de Permiso:</label>

                            <div class="col-md-6">
                                <input type="time" class="form-control" min="00:01" max="09:30" name="hours_permit" value="{{ old('hours_permit') }}">

                                @if ($errors->has('hours_taken'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('hours_taken') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('days_taken') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="hidden" class="form-control" name="days_taken" value="{{ old('days_taken') }}">
                                <input type="time" class="form-control" name="hours_permit" value="{{ old('hours_permit') }}">
